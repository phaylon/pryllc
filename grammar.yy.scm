...
(define parser
  (lr-driver
    '#(((*default* -3)
       ...
       ((*default* -37))
       ((*default* -36))
       ((*default* -34) (OP_INC_DEC -32) (OP_ASSIGN_SC -32) (OP_ASSIGN -32))
       ((*default* -11))
       ((*default* *error*) (OP_ASSIGN 24) (OP_ASSIGN_SC 23) (OP_INC_DEC 22))
       ((*default* -8)
        (SEMICOLON 38)
        (OP_L_OR 37)
        (OP_L_ERR 36)
        ...
        (OP_MINUS 26)
        (OP_H_MATH 25))
       ((*default* -12) (OP_EQUAL 40))
       ((*default* -2))
       ((*default* *error*) (*eoi* 41))
       ((*default* -18))
       ((*default* -19) (OP_H_MATH 25))
       ((*default* -16)
        (OP_H_MATH 25)
        (OP_MINUS 26)
        (OP_PLUS 27)
       ...
       ((*default* -14)
        ...
        (OP_TERN_THEN 34))
       ((*default* -21))
       ((*default* -22) (OP_H_MATH 25))
       ((*default* -23) (OP_H_MATH 25))
       ((*default* -24) (OP_H_MATH 25) (OP_MINUS 26) (OP_PLUS 27))
       ((*default* -25)
        (OP_H_MATH 25)
        (OP_MINUS 26)
        (OP_PLUS 27)
    ...
    (vector
      ...
      (lambda (___stack ___sp ___goto-table ___push yypushback)
        (let* (($2 (vector-ref ___stack (- ___sp 1)))
               ($1 (vector-ref ___stack (- ___sp 3))))
          (___push 2 5 (make-unary-operator $2 $1 'postfix))))
      (lambda (___stack ___sp ___goto-table ___push yypushback)
        (let* (($3 (vector-ref ___stack (- ___sp 1)))
               ($2 (vector-ref ___stack (- ___sp 3)))
               ($1 (vector-ref ___stack (- ___sp 5))))
